...
`[Core Marker][Certainty Operator][Optional Routing Suffix]`
...
| `savtren` | Training | "Known by training / Inherent domain" | Derived from native weights; represents high-probability baseline domain knowledge without fresh validation. |
